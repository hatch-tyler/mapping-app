...
def upgrade() -> None:
    ...
    op.add_column('datasets', sa.Column(
        'source_type', sa.String(50), server_default='local', nullable=False))
    op.add_column('datasets', sa.Column(
        'category', sa.String(50), server_default='reference', nullable=False))
    op.add_column('datasets', sa.Column(
        'geographic_scope', sa.String(50), nullable=True))
    op.add_column('datasets', sa.Column(
        'service_url', sa.String(1000), nullable=True))
    op.add_column('datasets', sa.Column(
        'service_type', sa.String(50), nullable=True))
    op.add_column('datasets', sa.Column(
        'service_layer_id', sa.String(255), nullable=True))
    op.add_column('datasets', sa.Column(
        'service_metadata', postgresql.JSONB, nullable=True))
    op.add_column('datasets', sa.Column(
        'last_service_check', sa.DateTime(timezone=True), nullable=True))
    op.add_column('datasets', sa.Column(
        'project_id', postgresql.UUID(as_uuid=True),
        sa.ForeignKey('projects.id', ondelete='SET NULL'), nullable=True))
    op.add_column('datasets', sa.Column(
        'is_privileged', sa.Boolean, server_default='false', nullable=False))
